...
public class DeleteAttachmentHandler : IRequestHandler<DeleteAttachmentCommand>
{
    ...
    public DeleteAttachmentHandler(IApplicationDbContext context, ICurrentUserService currentUser)
    {
        _context = context;
    ...
    public async Task Handle(DeleteAttachmentCommand request, CancellationToken ct)
    {
        ...
        var attachment = await _context.Attachments
            .FirstOrDefaultAsync(a => a.Id == request.AttachmentId && a.JobApplicationId == request.JobApplicationId, ct)
